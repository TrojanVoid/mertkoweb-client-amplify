        ...
        <>
            <div className="container py-[4rem]">
                <div className={`benefit-block ${props ? props : ''}`}>
                    <div className="list-benefit grid md:grid-cols-2 grid-cols-1 xl:gap-[160px] lg:gap-20 gap-10 gap-y-6">
                        <div className="benefit-item flex flex-col items-center justify-center">
                            ...
                            <div className="caption1 text-secondary text-center mt-2">Ürünlerimizin bir kısmı tescillidir; bu sayede belirli ürünlerimizle gönül rahatlığıyla pazarlama yapabilirsiniz</div>
                        </div>
